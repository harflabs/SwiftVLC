...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harflabs/SwiftVLC/releases/download/v0.2.0/libvlc.xcframework.zip",
      checksum: "cdef5c6e65ab3bcfb90500c975a1bf01957689466d4724492a174545cc438e5a"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
