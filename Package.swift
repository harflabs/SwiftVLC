...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harflabs/SwiftVLC/releases/download/v1.0.0/libvlc.xcframework.zip",
      checksum: "23509b945aafb97634d2e66af24a377d7bd50b672aba8f5dec1d6f9ef8614045"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
