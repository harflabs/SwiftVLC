...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harflabs/SwiftVLC/releases/download/v0.9.0/libvlc.xcframework.zip",
      checksum: "dda32f487e542c4235b48232932398622acd729ceca89bbd6c8038eeb9d2618d"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
