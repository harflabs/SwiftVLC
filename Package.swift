...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "libvlc",
      url: "https://github.com/harflabs/SwiftVLC/releases/download/v0.7.0/libvlc.xcframework.zip",
      checksum: "4b6ffe07ec04f22dee95c007ad15414f43088383bec0070099a75be6bec26081"
    ),
    .target(
      name: "CLibVLC",
      dependencies: ["libvlc"],
