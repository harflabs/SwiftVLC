...
/// Thread-safe singleton wrapping `libvlc_instance_t`.
///
/// `VLCInstance` is the entry point for all libVLC operations. A single
/// shared instance is sufficient for most applications.
///
/// ```swift
