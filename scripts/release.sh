...
# Release 1.1.0's frozen patch manifest owns extension version 11 plus the 0033
...
if ! "$SCRIPT_DIR/validate-native-extension-contract.sh" \
  ...
  echo "Error: release artifact does not implement native extension version 11 with Apple audio-session leases." >&2
